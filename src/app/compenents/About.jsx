  ...
  return (
    <section id="about">
      <div className="flex flex-col flex-wrap py-8 px-4 gap-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        {selectedSection === "overview" && (
          <div>
            <p className="text-[#F0F0F0] text-justify italic text-base sm:text-xl mb-4">
            ...
            <div className="md:flex md:justify-between md:mx-auto">
              <div className="md:px-6">
                ...
                <p className="text-[#F0F0F0] italic mb-4 text-base text-justify sm:text-xl sm:mb-0">
              ...
              <div className="md:px-6">
                ...
                <p className="text-[#F0F0F0] italic text-base text-justify sm:text-xl sm:mb-0">
                  ...
                  Excel. {"I'm"} excited to tackle new challenges in the data
                  field.
                </p>
              </div>
            </div>
